...
/**
 * @brief Constant for custom border type in PrintBox.
 *
 * This constant represents the custom border type option for a PrintBox. When this
 * border type is selected, custom characters for each border element must be provided.
 */
#define PRINTBOX_BORDER_CUSTOM 0

/**
 * @brief Constant for simple border type in PrintBox.
 *
 * This constant represents the simple border type option for a PrintBox. It uses
 * basic ASCII characters for the border elements.
 */
#define PRINTBOX_BORDER_SIMPLE 1

/**
 * @brief Constant for single-line border type in PrintBox.
 *
 * This constant represents the single-line border type option for a PrintBox. It uses
 * single-line box-drawing characters for the border elements.
 */
#define PRINTBOX_BORDER_SINGLE 2

/**
 * @brief Constant for double-line border type in PrintBox.
 *
 * This constant represents the double-line border type option for a PrintBox. It uses
 * double-line box-drawing characters for the border elements.
 */
 ...
 */
PrintBox* init_print_box(unsigned long width, const char* locale, int border_type, int word_wrap, ...);
